...
df= pd.read_csv("data2.txt", sep='\t', names=['tweetid','topic','sentiment','tweet1'])
data = df.tweet1
...
np.savetxt('data4.txt', df.values, fmt='%s', delimiter="\t")
#np.savetxt(r'C:\Users\Shreya Chigullapalli\python nlp codes\data4.txt', df.values)
#df.write.format("csv").save("C:\Users\Shreya Chigullapalli\python nlp codes")
"""
n = df.columns[4]
